...
if Server then
    ...
    pickupVehiclesWithPlayersRequiresPermission = false
    ...
    pickupPlayersRequiresPermission = false

    -- Do people need permission to spawn objects? (def: true)
    spawningRequiresPermission = false

    -- Do people need permission to remove stuff? (def: true)
    removingRequiresPermission = false
