...
function ScreenProgress:ConfigureLabels()
...
function ScreenProgress:LabelPostRender()
	self.labelDescriptionJob:Hide()
	self.labelDescriptionUnlock:Hide()
end


function ScreenProgress:ObjectValueChange(args)
...
function ScreenProgress:Render()
...
function ScreenProgress:RenderTutorial()
...
function ScreenProgress:RenderUnlock(unlock)
...
function ScreenProgress:SetActive(bool)
	self.active = bool
	if not bool then
		self.labelDescriptionJob:Hide()
		self.labelDescriptionUnlock:Hide()
...
function ScreenProgress:SetLanguages()
	self.Languages = Languages()
	self.Languages:SetLanguage("LABEL_PROGRESS", {["en"] = "Progress", ["pt"] = "Progresso"})
